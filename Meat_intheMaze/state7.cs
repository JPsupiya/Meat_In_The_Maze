...
namespace Meat_intheMaze
{
    public partial class state7 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (status == 1)
            {
                meatbox7.Image = Properties.Resources._23584570_1392330420893132_1201545388_n;
                status = 2;
            }
            else if (status == 2)
            {
                meatbox7.Image = Properties.Resources._23635196_1392330424226465_1279969046_n___Copy;
                status = 1;
            }
            //กำแพง
